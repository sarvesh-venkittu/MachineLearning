...
def load_data(filename):
    ...
    #opens file and initially stores data into 'evidence' and 'label' lists
    ...
    for row in evidence:
        ...
        row[10] = months.index(row[10]) #Month
...
def evaluate(labels, predictions):
    ...
    """
    #counts true negatives and true prositives
    sensitivity = 0
    specificity = 0
    ...
    #calculates proportion (true/total)
